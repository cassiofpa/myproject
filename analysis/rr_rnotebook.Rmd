...
knitr::include_graphics("assets/level-1.png")
```
...
knitr::include_graphics("assets/level-2.png")
```
</div>
...
```{r, out.width = "70%",fig.cap= ""}
knitr::include_graphics("assets/level-3.png")
```
...
<div id="left">
```{r, out.width = "80%",fig.cap= ""}
knitr::include_graphics("assets/level-4.png")
```
</div>
...
knitr::include_graphics("assets/open.png")
```
...
knitr::include_graphics("assets/rnotebook.png")
```
...
```{r, out.width = "60%",fig.cap= ""}
knitr::include_graphics("assets/yaml.png")
```
...
knitr::include_graphics("assets/chunk1.png")
```
...
knitr::include_graphics("assets/rnotexto.png")
```
